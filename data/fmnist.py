...
# https://apache-mxnet.s3-accelerate.dualstack.amazonaws.com/gluon/dataset/fashion-mnist/train-images-idx3-ubyte.gz
    ...
    def __init__(self, root, train=True, transform=None, target_transform=None, download=False,
                 noise_type=None, noise_rate=0.4, random_state=0):
        ...
        # print("Initing the train %s....." % {str(self.train)})
        ...
        if self.train:
            # self.train_data, self.train_labels = gdata.vision.FashionMNIST(train=True)
